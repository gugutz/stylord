 import {buildRule, buildPseudoRule} from './build-rule'
 ...
 */
 export default (selector, declarations) => {
   const pseudoSelectors = buildPseudoRule(selector, declarations)
   const normalSelector = buildRule(selector, declarations)

   return normalSelector + pseudoSelectors
 }
