...
## Reporting Issues
Found a problem? Want a new feature? First of all see if your issue or idea has [already been reported](https://github.com/thiamsantos/stylord/issues).
If don't, just open a [new clear and descriptive issue](https://github.com/thiamsantos/stylord/issues/new).
...
- Fork it!
- Clone your fork: `git clone https://github.com/<your-username>/stylord`
- Navigate to the newly cloned directory: `cd stylord`
